  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <h2
          className={`text-4xl md:text-5xl font-bold text-center mb-12 transform transition-all duration-3000 delay-1000 ${
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Section */}
          <div
            className={`space-y-6 transform transition-all duration-3000 delay-1000 ${
          ...
          {/* Right Section */}
          <div
            className={`order-first md:order-last transform transition-all duration-3000 delay-1000 ${
              inView ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"
            }`}
            style={{ willChange: "transform, opacity" }}
          >
